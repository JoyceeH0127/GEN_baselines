#!/usr/bin/env python3
"""Batch FLUX.2-dev inference for the BDD100K insertion schedule.
...
DEFAULT_OUTPUT_ROOT = Path("/home/qinma/yelo/outputs/FLUX.2-dev_BDD100K")
...
def source_for(root: Path, task: dict[str, Any]) -> Path:
    """Return the source image path stored in the BDD100K schedule."""
...
def object_phrase(counts: dict[str, int]) -> str:
    ...
    parts: list[str] = []
    for json_name, singular, plural in names:
